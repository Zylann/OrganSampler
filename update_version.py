...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright Zylann, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/MySampler-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySampler-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySampler-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySampler-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySampler-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySampler-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MySampler-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MySampler.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MySampler.iss",inplace=1):
